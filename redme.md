...
sql = text("SELECT short_name, pace, shooting, defending FROM jogadores_20")
...
## 📊 Impacto esperado
- Simulação de pipelines analíticos longitudinais.  
- Base para dashboards e análises externas.  
- Exercícios práticos para consolidar **ETL, SQL, Pandas e análise de dados esportivos**.  

---

## 📂 Saída final
- Arquivo consolidado: `relatorio_fifa_15_21_sj90.csv`  
- Contém evolução de atributos dos 20 jogadores âncora entre FIFA 15 e FIFA 21.  

---

## 👨‍💻 Autor
Projeto desenvolvido por **Weslley Soares**  
Fundador e gestor técnico da **Mercattus**, especialista em arquitetura de sistemas, automações, integrações e SEO.  
```
